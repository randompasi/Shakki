...
public class ChessLogicTest extends BeforeEachTest {
    ...
    public void castlingTest(){
        ...
        assertEquals(king, chessLogic.getSpot(6,0).annaPiece());
        assertEquals(5, rook.annaX());
       assertEquals(0, rook.annaY());
       assertEquals(rook, chessLogic.getSpot(5,0).annaPiece());
    ...
    public void enPassantTest(){
        ...
        assertEquals(whitePawn, chessLogic.getSpot(0,5).annaPiece());
        assertEquals(0, whitePawn.annaX(), whitePawn.annaX()+" "+whitePawn.annaY());
        assertEquals(null, chessLogic.getSpot(0,4).annaPiece(), "Blackpawn");
